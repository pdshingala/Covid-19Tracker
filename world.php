...
<body onload="fatchworld()">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark nav_style p-3 sticky-top" id="homeid">
		...
		<button class="navbar-toggler nav_toggle" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
	...
	<section class="">
		<div class="corona_states container">
			<div>
				<h3 class="text-uppercase text-center">Covid-19 World Statistics</h3>
			</div>

			<div class="table-responsive">
				<table class="table table-bordered table-striped text-center" id="world_table">
					<tr>
						<th>Country</th>
						<th>Total Cases</th>
